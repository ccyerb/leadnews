...
public class HotArticleServiceImpl implements HotArticleService {
    ...
    /**
     * 计算热点文章
     * 1.查询前5天的文章数据 得到list-> computeHotArticle -> cacheTagToRedis
     */
    @Override
    ...
    /**
     * 为每个频道缓存30条分值较高的文章, 并且设置推荐数据 30条分值较高的文章
    ...
    private List<HotArticleVo> computeHotArticle(List<ApArticle> apArticleList) {
        ...
        //apArticleList -> loop -> HotArticleVo -> computeScore -> setScore -> add into hotArticleVoList
